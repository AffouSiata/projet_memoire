...
export declare class AdminController {
    ...
    getPatients(search?: string, isActive?: boolean, page?: number, limit?: number): Promise<{
        data: {
            id: string;
            email: string;
            nom: string;
    ...
    getRendezVous(statut?: StatutRendezVous, patientId?: string, medecinId?: string, page?: number, limit?: number): Promise<{
        data: ({
            patient: {
                id: string;
                nom: string;
    ...
    updateProfile(user: any, updateProfileDto: UpdateAdminProfileDto): Promise<{
        id: string;
        email: string;
        nom: string;
        prenom: string;
    ...
    getAuditLogs(limit?: number, page?: number, status?: string): Promise<{
        data: {
            id: string;
            user: string;
            action: string;
