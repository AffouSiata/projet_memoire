...
const MedecinLayout = ({ children }) => {
  ...
  // Function to safely translate specialties
      ...
      >
        ...
        <div className="relative flex items-center justify-between p-6 border-b border-slate-200/50 dark:border-gray-700/50">
          {isSidebarOpen && (
            <div className="flex items-center gap-3 animate-slide-in-left">
              ...
              <div>
                <p className="text-xs text-slate-500 dark:text-white font-medium">{safeT('common.doctorSpace', 'Espace Médecin')}</p>
              </div>
            </div>
          )}
          <button
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-slate-200/50 dark:border-gray-700/50 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm">
          ...
          >
            ...
            {isSidebarOpen && (
              <span className="relative text-sm font-semibold">{safeT('common.logout')}</span>
            )}
          </button>
        </div>
      </aside>
          ...
          <div className="relative bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl rounded-3xl shadow-2xl p-8 max-w-md w-full animate-scale-in border border-white/20 dark:border-gray-700/50 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-center text-gray-700 dark:text-gray-200 mb-8 leading-relaxed text-lg">
                {safeT('common.logoutMessage') || 'Êtes-vous sûr de vouloir vous déconnecter ?'}
              </p>
