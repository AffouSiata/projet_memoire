            ...
            <div className="relative group w-full">
              <div className="relative flex items-center gap-4 p-4 bg-white/60 dark:bg-gray-700/60 rounded-2xl backdrop-blur-sm border border-white/50 dark:border-gray-600/50 shadow-lg">
                <div className="relative">
                  <div className="relative w-14 h-14 bg-blue-700 rounded-2xl flex items-center justify-center text-white shadow-xl">
                ...
                <div className="flex-1 min-w-0 text-left">
                  ...
                  <p className="text-xs text-blue-700 dark:text-blue-400 truncate font-medium">{t('layout.administrator')}</p>
