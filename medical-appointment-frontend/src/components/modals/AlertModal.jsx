...
const AlertModal = ({
  ...
  const iconConfig = {
    ...
    warning: {
      ...
      btnColor: 'from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700',
    ...
    <div className="fixed inset-0 z-[150] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white dark:bg-gray-800 rounded-3xl shadow-2xl p-8 max-w-md w-full animate-scale-in overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <button
            onClick={onClose}
            className={`w-full px-8 py-4 bg-gradient-to-r ${config.btnColor} text-white rounded-2xl font-bold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105`}
          >
            {buttonText}
          </button>
        </div>
