            ...
            <div className="relative bg-red-500/10 dark:bg-red-900/30 backdrop-blur-xl rounded-2xl p-6 border border-red-200/50 dark:border-red-800/50 shadow-lg animate-scale-in">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 dark:text-gray-300 leading-relaxed">{typeof error === 'string' ? error : error?.message || JSON.stringify(error)}</p>
                </div>
              </div>
            </div>
          )}
                  ...
                  <div className="relative bg-white/80 dark:bg-gray-800/90 backdrop-blur-xl rounded-2xl shadow-lg p-6 border border-white/50 dark:border-gray-700/50">
                    ...
                    {section.type === 'availability' && (
                      <div className="space-y-6">
                              ...
                              return (
                                <button
                                  ...
                                  className={`p-3 rounded-xl border-2 transition-all duration-300 font-medium ${
                                    isSelected
                                      ? 'border-blue-500 bg-blue-50 dark:bg-blue-950/20 text-blue-800 dark:text-blue-300'
                        ...
                        <div className="bg-blue-50 dark:bg-blue-950/20 backdrop-blur-xl rounded-xl p-4 border border-blue-200/50 dark:border-blue-900/50">
                          <div className="flex items-start gap-3">
                            <ClockIcon className="w-5 h-5 text-blue-700 dark:text-blue-400 flex-shrink-0 mt-0.5" />
