...
const MedecinAppointments = () => {
  ...
  const translateMotif = (motif) => {
    ...
    // Map de traduction exacte pour tous les motifs de la base de données
    const exactMotifs = {
      'Bilan de santé général': t('motifs.generalHealthCheckup'),
      'Consultation': t('common.consultation'),
      'Consultation cardiologie': `${t('common.consultation')} ${t('specialties.cardiology')}`,
      'Consultation de routine cardiologie': `${t('motifs.routineConsultation')} ${t('specialties.cardiology')}`,
      'Consultation de suivi cardiologique': `${t('motifs.followUpConsultation')} ${t('specialties.cardiology')}`,
      'Consultation dermatologie - Acné': `${t('common.consultation')} ${t('specialties.dermatology')} - ${t('motifs.acne')}`,
      'Consultation dermatologie - Suivi traitement': `${t('common.consultation')} ${t('specialties.dermatology')} - ${t('motifs.treatmentFollowUp')}`,
      'Consultation dermatologique': `${t('common.consultation')} ${t('specialties.dermatology')}`,
      'Consultation pédiatrique': `${t('common.consultation')} ${t('specialties.pediatrics')}`,
      'Consultation pédiatrique - Vaccination': `${t('common.consultation')} ${t('specialties.pediatrics')} - ${t('motifs.childVaccination')}`,
      'Contrôle cardiaque': t('motifs.cardiacCheckup'),
      'Suivi cardiologique': `${t('motifs.followUp')} ${t('specialties.cardiology')}`,
      'Suivi pédiatrique': `${t('motifs.followUp')} ${t('specialties.pediatrics')}`,
    ...
    if (exactMotifs[motif]) {
      return exactMotifs[motif];
    }

    // Si pas de correspondance exacte, retourner le motif original
    return motif;
  };
                    ...
                    <div className="flex items-center gap-4 flex-1">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 text-sm text-gray-600 dark:text-gray-400">
                          ...
                          <div className="flex items-center gap-2 px-3 py-1.5 bg-gray-50 dark:bg-gray-700 rounded-lg">
                            <span className="font-medium">💬 {translateMotif(apt.motif) || t('medecin.appointments.consultation')}</span>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="group relative bg-gradient-to-br from-white/80 to-white/60 dark:from-gray-700/80 dark:to-gray-700/60 backdrop-blur-xl rounded-xl p-3 border border-white/20 dark:border-gray-600/50 shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105 overflow-hidden">
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-sm font-bold text-gray-900 dark:text-white">
                        {translateMotif(selectedAppointment.motif) || t('medecin.appointments.modal.generalConsultation')}
                      </p>
                    </div>
                  </div>
                </div>
