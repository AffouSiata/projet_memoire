              ...
              <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-gradient-to-br from-secondary-50 to-primary-50 dark:bg-secondary-900/20 dark:to-primary-900/20 rounded-2xl p-5 border border-secondary-200/50 dark:border-secondary-700/50">
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-gradient-to-br from-green-50 to-green-100 dark:bg-green-900/20 dark:to-green-900/30 rounded-2xl p-5 border border-green-200/50 dark:border-green-700/50">
                      <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-gradient-to-br from-blue-50 to-purple-50 dark:bg-blue-900/20 dark:to-purple-900/20 rounded-2xl p-5 border border-blue-200/50 dark:border-blue-700/50">
                      <div className="flex items-center gap-3 mb-2">
