    ...
    <MedecinLayout>
      <div className="min-h-screen bg-[#F7F9FC] dark:bg-gray-900 p-8 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute -bottom-20 left-1/3 w-80 h-80 bg-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="mb-8 animate-slide-up">
            <div className="relative bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-lg overflow-hidden">
              ...
              <div className="absolute top-0 right-0 w-64 h-64 bg-blue-100/40 dark:bg-blue-900/20 rounded-full blur-3xl"></div>
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex-1">
                    {/* Badge */}
                    <div className="inline-flex items-center gap-2.5 px-4 py-2 bg-blue-50 dark:bg-blue-900/30 rounded-2xl mb-4">
                      <div className="w-2 h-2 bg-blue-500 rounded-full animate-pulse"></div>
                      <span className="text-xs font-bold text-blue-600 dark:text-blue-400 uppercase tracking-wider">{t('medecin.patients.badge')}</span>
                    </div>
                    ...
                    <div className="flex items-center gap-4 mb-3">
                      ...
                      <div className="w-14 h-14 bg-blue-600 rounded-2xl flex items-center justify-center shadow-lg animate-bounce-slow">
          ...
          <div className="grid grid-cols-4 gap-4 mb-8">
            ...
            >
              <div className="w-12 h-12 bg-blue-100 dark:bg-blue-950/50 rounded-2xl flex items-center justify-center mb-4 animate-pulse-soft">
                <HeartIcon className="w-6 h-6 text-blue-500 dark:text-blue-400" />
              </div>
            ...
            {filteredPatients.length > 0 ? (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 mb-5">
                      ...
                      <div className="relative">
                        ...
                        <div className="relative w-16 h-16 bg-blue-600 rounded-2xl flex items-center justify-center font-bold text-xl text-white shadow-xl group-hover:scale-110 transition-transform">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 px-3 py-1.5 bg-blue-50 dark:bg-blue-900/30 rounded-lg w-fit">
                    ...
                    <div className="space-y-3 mb-5">
                      ...
                      {/* Prochain RDV */}
                      {nextAppt && (
                        <div className="flex items-center gap-3 px-3 py-2.5 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
                      ...
                      <div className="pt-3 border-t border-gray-200/50 dark:border-gray-700/50 space-y-2">
                        <div className="flex items-center gap-2 text-sm">
                          <div className="w-7 h-7 bg-blue-100 dark:bg-blue-950/30 rounded-lg flex items-center justify-center flex-shrink-0">
                            <PhoneIcon className="w-3.5 h-3.5 text-blue-700 dark:text-blue-400" />
                          </div>
                        ...
                        <div className="flex items-center gap-2 text-sm">
                          <div className="w-7 h-7 bg-blue-100 dark:bg-blue-950/30 rounded-lg flex items-center justify-center flex-shrink-0">
                            <EnvelopeIcon className="w-3.5 h-3.5 text-blue-700 dark:text-blue-400" />
                          </div>
                          <span className="text-gray-600 dark:text-gray-400 truncate font-medium">
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                    >
              ...
              <div className="col-span-full relative bg-white/80 dark:bg-gray-800/90 backdrop-blur-xl rounded-3xl p-16 text-center border border-white/20 dark:border-gray-700/50 shadow-xl animate-scale-in">
                <div className="relative inline-block mb-6">
                  ...
                  <div className="relative w-24 h-24 bg-blue-500 rounded-full flex items-center justify-center shadow-xl">
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="relative group">
                    <div className="absolute inset-0 bg-blue-700/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
                    <div className="relative bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-5 border border-blue-200/50 dark:border-blue-800/50">
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-5 border border-blue-200/50 dark:border-blue-700/50">
                      <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative bg-blue-50 dark:bg-blue-950/20 rounded-2xl p-5 border border-blue-200/50 dark:border-blue-800/50">
                      <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="relative bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm rounded-xl p-4 border border-gray-200/50 dark:border-gray-600/50">
                        <div className="flex items-center gap-3 mb-2">
                          <div className="w-8 h-8 bg-blue-100 dark:bg-blue-950/30 rounded-lg flex items-center justify-center">
                            <PhoneIcon className="w-4 h-4 text-blue-700 dark:text-blue-400" />
                          </div>
                    ...
                    <div className="group relative">
                      ...
                      <div className="relative bg-white/80 dark:bg-gray-700/80 backdrop-blur-sm rounded-xl p-4 border border-gray-200/50 dark:border-gray-600/50">
                        <div className="flex items-center gap-3 mb-2">
                          <div className="w-8 h-8 bg-blue-100 dark:bg-blue-950/30 rounded-lg flex items-center justify-center">
                            <EnvelopeIcon className="w-4 h-4 text-blue-700 dark:text-blue-400" />
                          </div>
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4 flex-1">
                              ...
                              <div className="relative">
                                <div className={`absolute inset-0 rounded-xl blur-lg opacity-50 ${
                                  appt.statut === 'CONFIRME' ? 'bg-blue-500' :
                            ...
                            <span className={`px-4 py-2 rounded-xl text-xs font-bold shadow-md whitespace-nowrap ${
                              appt.statut === 'CONFIRME' ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400' :
